...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lragssm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lragssm.containers.anotherwebservice.com/
...
```
git clone git@github.com:dark0rbit8/container-lragssm.git
cd container-lragssm
```
...
```
docker attach container-lragssm
```
